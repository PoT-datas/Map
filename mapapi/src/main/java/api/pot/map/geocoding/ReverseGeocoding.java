...
public final class ReverseGeocoding extends Geocoder {
	...
	/**
	 * Set result types.
	 * Available types found in {@link api.pot.map.geocoding.Constants.AddressComponents AddressComponents}
	...
	/**
	 * Set location types.
	 * Available types found in {@link api.pot.map.geocoding.Constants.LocationTypes LocationTypes}
	 * @param types The types
	 */
