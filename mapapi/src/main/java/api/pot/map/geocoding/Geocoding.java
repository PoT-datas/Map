...
import api.pot.map.geocoding.Models.Bounds;
...
public final class Geocoding extends Geocoder {
	...
	/**
	 * Add a component.
	 * Available types are {@link api.pot.map.geocoding.Constants.AddressTypes AddressTypes}.[ROUTE, LOCALITY, ADMINISTRATIVE_AREA, POSTAL_CODE, COUNTRY]
